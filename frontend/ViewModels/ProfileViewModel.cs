...
public partial class ProfileViewModel : ObservableObject
{
    ...
    [ObservableProperty] private double _tableCellMargin = 0.1;
    [ObservableProperty] private string _tableCellMarginUnit = "cm";
    ...
    partial void OnTableCellMarginChanged(double value) => IsDirty = true;
    partial void OnTableCellMarginUnitChanged(string value) => IsDirty = true;
    ...
    private void MapProfileToFields(ProfileConfigDto p)
    {
        ...
        TableCellMargin = p.Table.CellMargin;
        TableCellMarginUnit = p.Table.CellMarginUnit;
    ...
    private void MapFieldsToProfile(ProfileConfigDto p)
    {
        ...
        p.Table.CellMargin = TableCellMargin;
        p.Table.CellMarginUnit = TableCellMarginUnit;
